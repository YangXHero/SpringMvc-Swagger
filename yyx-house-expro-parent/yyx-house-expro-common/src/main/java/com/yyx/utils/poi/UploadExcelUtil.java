    ...
    public class UploadExcelUtil {  
        ...
        public static void main(String[] args) {  
        	 UploadExcelUtil eu = new UploadExcelUtil();  
        ...
        public  UploadExcelUtil(String excelPath){  
         ...
         * @return 
         */  
        public  UploadExcelUtil RestoreSettings(){  
        	 UploadExcelUtil instance = new   UploadExcelUtil(this.excelPath);  
            return instance;  
        }  
